...
def sympy_E_Pauli(value_r, value_si, value_sj, samespin, debug=None):
    ...
    if samespin == True:
        ...
        dE_up_updr = lambdify([rho, r, si, sj], dE_up_updr,
                              modules=['numpy', 'sympy'])
        ...
        dE_up_updsi = lambdify(
            [rho, r, si, sj], dE_up_updsi, modules=['numpy', 'sympy'])
        ...
        dE_up_updsj = lambdify(
            [rho, r, si, sj], dE_up_updsj, modules=['numpy', 'sympy'])
        dE_up_updsj = dE_up_updsj(value_rho, value_r, value_si, value_sj)
        ana_fs2 = -1*0.9*dE_up_updsj
        # eval(E_up_up)
        E_up_up = lambdify([rho, r, si, sj], E_up_up,
                           modules=['numpy', 'sympy'])
    ...
    if samespin == False:
        ...
        # print dE_up_downdr
        dE_up_downdr = lambdify(
            [rho, r, si, sj], dE_up_downdr, modules=['numpy', 'sympy'])
        ...
        print(dE_up_downdsi)
        dE_up_downdsi = lambdify(
            [rho, r, si, sj], dE_up_downdsi, modules=['numpy', 'sympy'])
        ...
        print(dE_up_downdsj)
        dE_up_downdsj = lambdify(
            [rho, r, si, sj], dE_up_downdsj, modules=['numpy', 'sympy'])
        dE_up_downdsj = dE_up_downdsj(value_rho, value_r, value_si, value_sj)
        ana_fs2 = -1*0.9*dE_up_downdsj
        #
        E_up_down = lambdify([rho, r, si, sj], E_up_down,
                             modules=['numpy', 'sympy'])
